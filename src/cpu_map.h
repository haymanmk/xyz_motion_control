...
// Mock hardware related keywords
#define MOCK_VAR
#ifdef MOCK_VAR
static uint8_t mock_int8 = 0x00;
#define DDRB mock_int8
#define DDRC mock_int8
#define DDRD mock_int8

#define PORTB mock_int8
#define PORTC mock_int8
#define PORTD mock_int8

static uint8_t TCNT0 = 0x00; // timer 0 counter
static uint8_t TCCR0B = 0x00;
static uint8_t CS01 = 0x01;
static uint16_t OCR1A = 0x0000;
static uint8_t PCMSK1 = 0x00;
static uint8_t PCIE1 = 0x01;
static uint8_t PCICR = 0x00;
static uint8_t PINC = 0x00;
